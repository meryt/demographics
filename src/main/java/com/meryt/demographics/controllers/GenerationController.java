...
public class GenerationController {
     ...
     * generation.
     *
     * @param personFamilyPost parameters used to generate the families
    ...
    public List<FamilyResponse> postGeneration(@RequestBody PersonFamilyPost personFamilyPost) {

        return generationService.processGeneration(personFamilyPost).stream()
                .map(FamilyResponse::new)
                .collect(Collectors.toList());
    }
